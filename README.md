...
```bash
git clone https://github.com/0x0funky/agent-sprite-forge.git agent-sprite-forge
# … this Cursor port lives alongside as agent-sprite-forge-cursor; cd into it ↓
...
Copies the skills into `./.cursor/skills/` so they're shared with anyone who clones the repo.
